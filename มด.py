...
#ki = LINE("hmokep001@gmail.com","2522543hmok")
#ki.log("Auth Token : " + str(ki.authToken))

#kk = LINE("hmokep002@gmail.com","2522543hmok")
#kk.log("Auth Token : " + str(kk.authToken))

#kc = LINE("hmokep003@gmail.com","2522543hmok")
#kc.log("Auth Token : " + str(kc.authToken))

#ks = LINE("hmokep004@gmail.com","2522543hmok")
#ks.log("Auth Token : " + str(ks.authToken))

#kz = LINE("hmokep005@gmail.com","2522543hmok")
...
RfuBot=[lineMID]
Family=["ue8d02741193a607ffda1a46cf13856ae",lineMID]
admin=['ue8d02741193a607ffda1a46cf13856ae',lineMID]
adminMID="ue8d02741193a607ffda1a46cf13856ae"
...
#    "blacklist":{},
    ...
    "Respontag":"™─┅═ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═┅─",
    "ResponPM":"™─┅═ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═┅─",
    "replyPesan": "Sorry , i'm busy right now.",
    "message":"™─┅═ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ",
    "comment":"™─┅═ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═┅─ ",
    "Wc":"กรุณาตั้งคนเข้า",
    "bye":"กรุณาตั้งคนออก",
    "add":"™─┅═ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═┅─",
    "kick":"ยังไม่ได้ตั้งคำทักเตะ",
    "c":"『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』",
    "s":"",
    "userAgent": [
...
def helpsetting():
    key = settings["s"]
    key = key.title()   
    helpSetting = """╭━━{ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ}
┣━━━━━━━━━━━━━━━━━
┃    { โหมดคำสั่งกลุ่ม }
┣━━━━━━━━━━━━━━━━━
┃•◈➣ แอด
         ...
         #       if text.lower() == "คำสั่ง":
          ...
          #          link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
            #        line.sendFooter(to, myHelp, icon, name, link)
                    ...
                    start = time.time()
                    line.sendMessage(to, "『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』")
                ...
                if text.lower() == 'ออน':
                    ...
                    line.sendMessage(to, "ปกติดีครับ\n『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』")
...
#===========Protection============#
                   ...
                   if msg._from in admin:
                      ...
                      if spl == 'on':
                          if msg.to in protectqr:
                               ...
                               msgs = "╠⍣⌲ สถานะการป้องกันกลุ่ม : [ เปิด ]\n╠⍣⌲ ชื่อกลุ่ม : "  +str(ginfo.name)
                          line.sendMessage(msg.to, "        ⚠「 การป้องกันคนเปิดเฉพาะในกลุ่มนี้ 」⚠\n" + msgs)
                      elif spl == 'off':
                            if msg.to in protectqr:
                                 protectqr.remove(msg.to)
                                 ginfo = line.getGroup(msg.to)
                                 msgs = "╠⍣⌲ สถานะการป้องกันกลุ่ม : [ ปิด ]\n╠⍣⌲ ชื่อกลุ่ม : "  +str(ginfo.name)
                            else:
                                 msgs = "Protect url sudah tidak aktif"
                            line.sendMessage(msg.to, "          ⚠「 การป้องกันลิ้งเฉพาะในกลุ่มนี้ 」⚠\n" + msgs)
                   ...
                   if msg._from in admin:
                      ...
                      if spl == 'on':
                          if msg.to in protectkick:
                               ...
                               ginfo = line.getGroup(msg.to)
                               msgs = "╠⍣⌲ สถานะการป้องกันกลุ่ม : [ เปิด ]\n╠⍣⌲ ชื่อกลุ่ม : "  +str(ginfo.name)
                          line.sendMessage(msg.to, "        ⚠「 การป้องกันคนเตะกันเฉพาะในกลุ่มนี้ 」⚠\n" + msgs)
                      elif spl == 'off':
                            if msg.to in protectkick:
                            ...
                            line.sendMessage(msg.to, "        ⚠「 การป้องกัยคนเตะกันเฉพาะในกลุ่มนี้ 」⚠\n" + msgs)
                   ...
                   if msg._from in admin:
                      ...
                      if spl == 'on':
                          if msg.to in protectjoin:
                               ...
                               ginfo = line.getGroup(msg.to)
                               msgs = "╠⍣⌲ สถานะการป้องกันกลุ่ม : [ เปิด ]\n╠⍣⌲ ชื่อกลุ่ม : "  +str(ginfo.name)
                          line.sendMessage(msg.to, "          ⚠「 การป้องกันคนเข้ากลุ่มเฉพาะในกลุ่มนี้ 」⚠\n" + msgs)
                      elif spl == 'off':
                            if msg.to in protectjoin:
                   ...
                   if msg._from in admin:
                      ...
                      if spl == 'on':
                          if msg.to in protectinvite:
                               ...
                               ginfo = line.getGroup(msg.to)
                               msgs = "Status : [ ON ]\nDi Group : " +str(ginfo.name)
                          line.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                      elif spl == 'off':
                            if msg.to in protectinvite:
                   ...
                   if msg._from in admin:
                      ...
                      if spl == 'on':
                          ...
                          line.sendMessage(msg.to, "「 Status Protection 」\n" + msgs)
#===========Protection============#
                elif text.lower() == 'แอด':
                    group = line.getGroup(to)
                  ...
                  if msg._from in Family:
                    ...
                    if msg.toType == 2:
                        ...
                        if G.preventedJoinByTicket == False:
                            ...
                            G.preventedJoinByTicket = True
                            line.updateGroup(G)
                elif msg.text in ["สาวๆกลับ","บอทออก","ออกไป","#bye"]:
                    if msg.toType == 2:
                        ginfo = line.getGroup(msg.to)
                        try:
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
